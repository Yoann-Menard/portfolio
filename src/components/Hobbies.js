			...
			<ul>
				...
				<h3>
					<li>
						...
						<p class='paragraph-dkc2 light blue-text'>
							<strong>
								J'ai joué à mon premier jeu vidéo à l'âge de 4 ans
								<br />
								"Donkey Kong Country 2: Diddy's Kong Quest" il a été développé
								par{' '}
								<a
				...
				<h3>
					<li>
						...
						<div class='computer-container'>
							<p class='paragraph-computer-science light white-text'>Lorem ipsum dolor sit amet</p>
							<a
